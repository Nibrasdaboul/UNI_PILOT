...
import { ArrowRight, Sparkles, ShieldCheck, Zap, LayoutDashboard, Calendar, BarChart3, GraduationCap, Globe, Moon, Sun } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/20">
      ...
      {showAuth ? (
        ...
        <>
          ...
          {/* Features */}
          <section className="py-24 px-6 border-t bg-muted/20">
...
function FeatureCard({ icon: Icon, title, description, index = 0 }) {
  return (
    <div 
      className="p-8 rounded-3xl border bg-card hover:border-primary/50 transition-all duration-300 group hover:shadow-2xl hover:shadow-primary/5"
      data-aos="fade-up"
