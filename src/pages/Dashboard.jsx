    ...
    <div className="space-y-6 sm:space-y-8 pb-8 sm:pb-12" data-testid="dashboard-page">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <Card className="rounded-2xl sm:rounded-[2rem] border shadow-sm overflow-hidden bg-card/50 backdrop-blur-sm">
          <CardHeader className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b bg-muted/20 px-4 sm:px-6 md:px-8 py-4 sm:py-6">
            <div>
            ...
            {!data?.upcoming_tasks?.length ? (
              ...
              <div className="divide-y">
                {data.upcoming_tasks.map((task) => (
                  <div key={task.id} className="group hover:bg-muted/30 transition-all px-8 py-5 flex items-center justify-between">
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <Badge variant="outline" className="rounded-full text-[10px] uppercase font-bold tracking-wider px-2 py-0">
                            {task.task_type}
                          </Badge>
                        </div>
        ...
        <Card className="rounded-2xl sm:rounded-[2rem] border shadow-sm overflow-hidden bg-card/50 backdrop-blur-sm">
          <CardHeader className="px-8 py-6 border-b bg-muted/20">
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-xl font-display">{t('nav.courses')}</CardTitle>
