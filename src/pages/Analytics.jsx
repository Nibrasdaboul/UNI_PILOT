...
export default function Analytics() {
  ...
  return (
    <div className="space-y-8 pb-12" data-testid="analytics-page">
      ...
      {/* Main Charts Row */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <Card className="lg:col-span-2 rounded-[2rem] border shadow-sm bg-card/50 backdrop-blur-sm">
        ...
        {/* Summary Card */}
        <Card className="rounded-[2rem] border shadow-sm bg-gradient-to-br from-primary/5 to-secondary/5 border-primary/10 overflow-hidden">
          <CardHeader className="px-8 pt-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {courses.map((course) => (
          <Card key={course.id} className="rounded-[2rem] border shadow-sm bg-card/50 backdrop-blur-sm">
