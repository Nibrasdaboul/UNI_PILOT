...
const API_URL = import.meta.env.VITE_BACKEND_URL || (typeof window !== 'undefined' ? window.location.origin : '');
...
function createMockApi() {
  ...
  const mockGet = (url) => {
    ...
    if (u.includes('/courses/') && (u.includes('/modules') || u.includes('/chat'))) return Promise.resolve({ data: [] });
